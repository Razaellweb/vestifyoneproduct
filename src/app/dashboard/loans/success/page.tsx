  ...
  return (
    <div className="grid place-items-center py-12">
      <div className="card p-6 text-center max-w-md">
        ...
        <h3 className="text-xl font-semibold mt-2">Loan approved</h3>
        <p className="text-sm text-muted-foreground mt-1">₦{Number(amount||0).toLocaleString()} • Term: {term} months • Wallet credited</p>
